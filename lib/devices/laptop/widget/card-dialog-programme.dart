...
class CardDialogProgrammeLaptop extends StatefulWidget {
  final Article article;

  const CardDialogProgrammeLaptop({Key? key, required this.article})
      : super(key: key);
  @override
  _CardDialogProgrammeLaptopState createState() =>
      _CardDialogProgrammeLaptopState();
}

class _CardDialogProgrammeLaptopState extends State<CardDialogProgrammeLaptop> {
  late Size size;
  @override
    ...
    return LayoutBuilder(builder: (context, constraint) {
      return GestureDetector(
        onTap: () {
          ...
          readOtherProgramme(context, widget.article);
        },
        child: Padding(
